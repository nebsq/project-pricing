...
const Metrics = ({
  ...
  return (
    <Card className="bg-white/50 backdrop-blur-sm border border-[#FF4D00]/10 mb-6">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="economic-buyer-name">Economic Buyer Name</Label>
                <Input
                  id="economic-buyer-name"
                  value={economicBuyerName || ''}
                  onChange={(e) => onEconomicBuyerNameChange(e.target.value)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="ftes"
                  type="number"
                  value={ftes === null ? '' : ftes}
                  onChange={(e) => handleNumberChange(e.target.value, onFtesChange)}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleNumberChange(e.target.value, onVacanciesChange)}
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="applications"
                  type="number"
                  value={applications === null ? '' : applications}
                  onChange={(e) => handleNumberChange(e.target.value, onApplicationsChange)}
