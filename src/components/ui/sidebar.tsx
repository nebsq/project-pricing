...
import { SidebarContext, type SidebarContextValue, useSidebar } from "@/contexts/sidebar-context"
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-150 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-all ease-in-out md:flex", // Changed duration-200 to duration-150
            side === "left"
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:children:not(svg):opacity-0", // Add this
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:children:text-opacity-0", // Add this
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  [
    ...
    "group-data-[state=collapsed]:children:not(svg):hidden",
  ].join(" "),
  {
    variants: {
      variant: {
